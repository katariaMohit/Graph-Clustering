...
"""
import sys
sys.path.append(r'c:\users\sandeep-2\appdata\local\programs\python\python310\lib\site-packages')
...
def build_dmon(input_features,
  ...
  for n_channels in FLAGS.architecture:
    print("making object here")

    """"
    Read this documentation for better understanding of keras Layer class
    which is a super class for our GCN class 
    https://www.tensorflow.org/api_docs/python/tf/keras/layers/Layer
    """

    output = gcn.GCN(n_channels)([output, input_graph])
    #print("done with output ",output.shape)
